...
int32_t lps28dfw_status_get(const stmdev_ctx_t *ctx, lps28dfw_stat_t *val)
{
  ...
  lps28dfw_int_source_t int_source = {0};
  lps28dfw_ctrl_reg2_t ctrl_reg2 = {0};
  lps28dfw_status_t status = {0};
  int32_t ret = 0;
...
{
  lps28dfw_fifo_status2_t fifo_status2 = {0};
  lps28dfw_int_source_t int_source = {0};
  lps28dfw_status_t status = {0};
  int32_t ret = {0};
...
/**
  ...
  * @param  val      lps28dfw_data_ready_t struct
  * @retval          interface status (MANDATORY: return 0 -> no Error)
  *
  */
...
{
  lps28dfw_fifo_ctrl_t fifo_ctrl = {0};
  int32_t ret = {0};
...
{
  lps28dfw_fifo_status1_t fifo_status1 = {0};
  lps28dfw_fifo_status2_t fifo_status2 = {0};
  uint8_t reg[2] = {0};
  int32_t ret = {0};
